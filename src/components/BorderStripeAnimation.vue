  ...
  <div>
    <component :is="'style'" type="text/css">
      ...
      .anim-border-container__inner::after {
        background: repeating-linear-gradient(45deg, {{ borderColor }}, {{ borderColor }} 12px, #FFF 12px, #FFF 24px);
      ...
      .anim-border-container__inner.animating::after {
        background: repeating-linear-gradient(45deg, {{ borderColor }}, {{ borderColor }} 24px, #FFF 24px, #FFF 24px);
      }
    </component>
